...
INTAKE_FORM_SCHEMA: dict[str, Any] = {
    "$jsonSchema": {
        ...
        "properties": {
            ...
            "formTemplateSnapshot": {"bsonType": ["object", "null"]},
            "formName": {"bsonType": "string"},
            "category": {"bsonType": "string"},
            "patientId": {"bsonType": ["string", "null"]},
            "patientName": {"bsonType": "string"},
            "patientDob": {"bsonType": ["string", "null"]},
            "status": {"enum": ["draft", "new", "in-review", "complete", "needs-follow-up"]},
            "submittedBy": {"bsonType": "object"},
            "reviewedBy": {"bsonType": ["object", "null"]},
            "reviewedAt": {"bsonType": ["string", "null"]},
            "reviewLock": {"bsonType": ["object", "null"]},
            "completedBy": {"bsonType": ["object", "null"]},
