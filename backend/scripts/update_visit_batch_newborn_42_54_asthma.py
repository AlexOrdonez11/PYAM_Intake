...
def build_newborn(forms):
    sections = [
        ...
        },
        {
            ...
            "fields": [
                field("visit_concerns", "Do you have any concerns, questions, or problems that you would like to discuss today?", "textarea"),
                field("topics_how_you_are_feeling", "How You Are Feeling", "checkbox-group", options=["Your health", "Feeling sad", "Family stress", "Unwanted advice", "Starting a daily routine", "How you are doing with your baby", "Calming your baby", "Crib safety and where your baby sleeps"]),
                field("topics_getting_used_to_baby", "Getting Used to Your Baby", "checkbox-group", options=["How your baby sleeps", "Placing baby on back to sleep", "Drinking enough"]),
                field("topics_feeding", "Feeding Your Baby", "checkbox-group", options=["Jaundice (skin is yellow)", "Burping", "Breastfeeding", "Formula"]),
                field("topics_safety", "Safety", "checkbox-group", options=["Car safety seat", "Cigarette smoke", "Water heater temperature", "When to call the doctor's office", "Taking your baby's temperature", "Not getting sick", "Hand washing"]),
                field("topics_baby_care", "Baby Care", "checkbox-group", options=["Emergency situations", "Leaving the house", "Skin care", "Sunburns"]),
                ...
                field("family_major_changes", "Other than your baby's birth, have there been any major changes in your family lately?", "checkbox-group", options=["Move", "Job change", "Separation", "Divorce", "Death in the family", "Any other changes"]),
                field("family_major_changes_description", "If any other changes, describe", "textarea"),
