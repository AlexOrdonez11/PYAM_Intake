export const ASQ_2_MONTH_SCORE_CONFIG = {
  "2-months-visit": [
    {
      key: "communication",
      label: "Communication",
...
export function buildAsqScoreConfig(prefix, cutoffs, zones) {
  const areas = [
...
ASQ_2_MONTH_SCORE_CONFIG["15-months-visit"] = buildAsqScoreConfig(
  "asq15",
  { communication: 16.81, gross_motor: 37.91, fine_motor: 31.98, problem_solving: 30.51, personal_social: 26.43 },
  {
    communication: { belowMax: 15, monitorMax: 30 },
    gross_motor: { belowMax: 35, monitorMax: 45 },
    fine_motor: { belowMax: 30, monitorMax: 40 },
...
ASQ_2_MONTH_SCORE_CONFIG["18-months-visit"] = buildAsqScoreConfig(
  "asq18",
  { communication: 13.06, gross_motor: 37.38, fine_motor: 34.32, problem_solving: 25.74, personal_social: 27.19 },
  {
    communication: { belowMax: 10, monitorMax: 30 },
    gross_motor: { belowMax: 35, monitorMax: 45 },
    fine_motor: { belowMax: 30, monitorMax: 40 },
